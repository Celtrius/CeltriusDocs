...
// node_modules/.pnpm/@miletorix+vitepress-image-viewer@1.3.2_vue@3.5.32/node_modules/@miletorix/vitepress-image-viewer/dist/image-viewer.es.js
...
var ut = defineComponent({
  ...
  setup(h2, { expose: x }) {
    ...
    async function be(e, t = "", o) {
      z = (o == null ? void 0 : o.closest("main, article, .content, .vp-doc, .theme-doc, #main")) ?? document.querySelector("main, article, .content, .vp-doc, .theme-doc, #main") ?? null, G(z ?? void 0), k.value = "iv-fade";
      const b = (e || "").split("#")[0], M = (o == null ? void 0 : o.getAttribute("alt")) ?? t ?? "";
